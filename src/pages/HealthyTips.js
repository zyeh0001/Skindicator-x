  ...
  return (
    <div>
      ...
      <div className="container">
        <div className="row">
          <Section2
            topic="1. Wear sunscreen 365 days a year — rain or shine, indoors or out"
          ...
          <Section2
            ...
            content="Using multiple skincare products at the same time is a no-no. It's rough on the skin, leading to more pimples and clogged pores."
      ...
      <div className="container">
        <div className="row">
          ...
          <Section2
            ...
            content="It's important to figure out how to avoid touching your face. Not only does it spread bacteria and cause breakouts, but it can also cause scarring, wrinkle, and even cause the flu or other viruses."
      ...
      <div className="container">
        <div className="row">
          <Section2
            ...
            content="Don't just pay attention to the sun -- getting too close to heaters and fireplaces can also wreak havoc on your skin. It causes inflammation and the breakdown of collagen."
      ...
      <div className="container">
        <div className="row">
          ...
          />
          <Section2
            topic="8. Use the correct cleanser for your skin type"
      ...
      <div className="container">
        <div className="row">
          <Section2
            ...
            content="Sun protection is so important for your skin, preventing damage is a million times better than treating it afterward."
